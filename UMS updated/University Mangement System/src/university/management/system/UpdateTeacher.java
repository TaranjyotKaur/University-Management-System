...
public class UpdateTeacher extends JFrame implements ActionListener{
    ...
    JTextField tfcourse, tfaddress, tfphone, tfemail, tfqual,tfdepart;
    JLabel labelEmpId;
    ...
    UpdateTeacher() {
        ...
        tfdepart.setBounds(600, 400, 150, 30);
        add(tfdepart);
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) {
            ...
            String course = tfqual.getText();
            String branch = tfdepart.getText();
